...
import AcademicAvatarImage from '../assets/AcademicAvatar.png';

interface RealisticAcademicAvatarProps {
  isActive?: boolean;
  isSpeaking?: boolean;
}

const RealisticAcademicAvatar = ({ isActive = false, isSpeaking = false }: RealisticAcademicAvatarProps) => {
    ...
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      {isSpeaking && (
        <>
          ...
          />
          <div
            className="absolute rounded-full border-2 border-cyan-400/10"
            style={{
      ...
      >
        <img
          src={AcademicAvatarImage}
          alt="Academic Interviewer"
        ...
        {isSpeaking && (
          <div
            ...
            style={{
              background: `radial-gradient(circle, rgba(34, 211, 238, ${0.1 + pulseScale * 0.1}) 0%, transparent 70%)`,
            }}
          />
        )}
      </div>
...
export default RealisticAcademicAvatar;
